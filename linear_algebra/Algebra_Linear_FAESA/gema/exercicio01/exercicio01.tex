...
\runningheadrule
\firstpageheader{}{}{}
\runningheader{Revisão da Unidade 1: Matrizes}{}{Agosto/2018}
...
\ifpdf
  \usepackage[pdftex]{hyperref}
    \hypersetup{
      ...
      pdftitle={Revisão da Unidade 1: Matrizes},
      pdfauthor={Abrantes Araújo Silva Filho},
      pdfsubject={Matrizes},
      pdfkeywords={matrizes, conceitos, operações},
      pdfinfo={
...
\begin{parts}
  ...
  \part \vf[V] Para que uma matriz seja considerada triangular, todos os elementos que acima OU abaixo
  da diagonal principal (e não ambos) devem ser nulos.
...
Indique se a sentença é verdadeira (V) ou falsa (F):
\begin{parts}
  \part \vf[F] Uma matriz nula $0$ de ordem 1 pode ser uma matriz identidade
...
\begin{solutionorlines}[0.50in]
  Basta multiplicar todos os elementos da matriz pelo escalar.
\end{solutionorlines}
...
\begin{solutionorlines}[0.50in]
  ...
  dos elementos correspondentes em cada matriz.
\end{solutionorlines}
...
\begin{solutionorlines}[0.50in]
  Uma matriz quadrada $B$, da mesma ordem da matriz quadrada $A$, é dita inversa
