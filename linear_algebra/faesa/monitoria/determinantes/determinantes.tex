...
\begin{frame}[t]
  ...
  O determinante de uma matriz pode ser calculado pelo \emph{produto} dos
  \textbf{elementos} de \emph{uma} linha (ou coluna) e seus respectivos
  \textbf{cofatores} (estes, por sua vez, são obtidos a partir dos \textbf{menores
  complementares} dos elementos).
  \end{block}
  $\begin{vmatrix*}[r]
    3 & 2 & -1 & 0\\
    1 & -2 & 4 & 3\\
