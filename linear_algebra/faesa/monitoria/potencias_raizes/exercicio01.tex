...
\runningheadrule
\firstpageheader{}{}{}
\runningheader{Exercícios de revisão: potências e raízes}{}{Abril/2019}
...
\ifpdf
  \usepackage[pdftex]{hyperref}
    \hypersetup{
      ...
      pdftitle={Exercícios de revisão: potências e raízes},
      pdfauthor={Abrantes Araújo Silva Filho},
      pdfsubject={Potenciação e radiciação},
      pdfkeywords={potências, raízes, revisão, exercícios},
      pdfinfo={
...
\begin{figure}[H]
\begin{center}
\fbox{\includegraphics[scale=0.4]{imagens/linear_algebra.png}}
\end{center}
\end{figure}
...
\begin{center}
\textit{\textbf{\Large%
--- Exercícios de revisão: potências e raízes ---\\
\ \\
Abril/2019}}
\end{center}
